...
app.add_middleware(TrustedHostMiddleware, allowed_hosts=["your-api-domain.vercel.app"])

app.add_middleware(
    TrustedHostMiddleware, allowed_hosts=["*.vercel.app"]  # Allow all Vercel subdomains
)
